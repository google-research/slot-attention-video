...
"""Config for a large conditional SAVi model (SAVi-L).

SAVi (ResNet) operates on 128x128 video frames and uses a ResNet34 backbone.
This model is comparable to the SAVi Large model evaluated on MOVi++ in the SAVi
ICLR paper:
